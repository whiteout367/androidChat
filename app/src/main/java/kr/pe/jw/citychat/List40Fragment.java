 ...
 * Use the {@link List40Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class List40Fragment extends Fragment {
    ...
    public static List40Fragment newInstance(String param1, String param2) {
        List40Fragment fragment = new List40Fragment();
...
//        addItem("우리","40","서울","남");
    ...
    public void getUserListRequest() {
        ...
        StringRequest request = new StringRequest(
                Request.Method.GET,
                url = "http://3.82.172.28/chatBack/get_user_list.php?age=4",
