 ...
 * Use the {@link List50Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class List50Fragment extends Fragment {
    ...
    public static List50Fragment newInstance(String param1, String param2) {
        List50Fragment fragment = new List50Fragment();
...
//        addItem("우리","40","서울","남");
    ...
    public void getUserListRequest() {
        ...
        StringRequest request = new StringRequest(
                Request.Method.GET,
                url = "http://3.82.172.28/chatBack/get_user_list.php?age=5",
